...
const Hyperspeed = ({
  ...
  useEffect(() => {
    ...
    class App {
      ...
      onWindowResize() {
        if(disposed || !this.container) return;
      ...
      loadAssets() {
        // This can be simplified as postprocessing handles assets now
      ...
      tick() {
        ...
        this.onWindowResize(); // Check for resize every frame
    ...
    const app = new App(container, { ...effectOptions, distortion: distortions[effectOptions.distortion] });
  ...
  return <div id="lights" ref={mountRef} className="absolute inset-0 w-full h-full"></div>;
};
